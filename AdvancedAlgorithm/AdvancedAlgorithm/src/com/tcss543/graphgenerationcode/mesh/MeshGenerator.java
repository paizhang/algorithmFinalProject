 ...
 * November 21, 2008
 */
package com.tcss543.graphgenerationcode.mesh;
...
public class MeshGenerator {
	 ...
	 * graph. The line reads 'first node' 'second node' capacity , where the
	 * nodes are represented as (row #, column #). This method should be called
	 * with the correct capacity for this node; it doesn't generate them.
	 * 
	 * @param i1
	 *            - first node row #
	 * @param j1-
	...
	/**
	 * Utility method to generate edge capacities for mesh graph generator.
	 * These are constant with value c if the constCap flag is set, random on
	 * the range from 1 to c otherwise.
	 * 
